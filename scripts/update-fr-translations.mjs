...
set('hsConfigurator.options.handleTextures.silver', 'F1 argent')
set('hsConfigurator.options.handleTextures.gold', 'F4 vieil or')
set('hsConfigurator.options.handleTextures.white', 'Blanc')
set('hsConfigurator.options.handleTextures.black', 'Noir')
set('hsConfigurator.options.handleTextures.anthracite', 'Anthracite')
set('hsConfigurator.options.handleTextures.inox', 'Inox')
