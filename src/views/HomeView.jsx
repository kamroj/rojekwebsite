...
const HomePage = () => {
  ...
  const productData = {
    [PRODUCT_TYPES.WINDOWS]: {
      ...
      backgroundSrc: '/images/home-tiles/okna.webp',
    ...
    [PRODUCT_TYPES.DOORS]: {
      ...
      backgroundSrc: '/images/home-tiles/drzwi.webp',
    ...
    [PRODUCT_TYPES.TERRACE_DOORS]: {
      ...
      backgroundSrc: '/images/home-tiles/okna-przesuwne.webp',
    ...
    [PRODUCT_TYPES.FIRE_RESISTANT]: {
      ...
      backgroundSrc: '/images/home-tiles/ppoz.webp',
