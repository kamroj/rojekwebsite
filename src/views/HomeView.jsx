...
const HomePage = () => {
  ...
  const productData = {
    [PRODUCT_TYPES.WINDOWS]: {
      ...
      backgroundSrc: '/images/aboutus/okno-kafelka.webp',
    ...
    [PRODUCT_TYPES.DOORS]: {
      ...
      backgroundSrc: '/images/aboutus/drzwi-kafelka.webp',
    ...
    [PRODUCT_TYPES.TERRACE_DOORS]: {
      ...
      backgroundSrc: '/images/aboutus/hs-kafelka.webp',
    ...
    [PRODUCT_TYPES.FIRE_RESISTANT]: {
      ...
      backgroundSrc: '/images/aboutus/drzwi-ppoz-kafelka.webp',
