...
const CATEGORY_LABELS = {
  pl: {
    ...
    drzwi: 'Drzwi',
    oknaDrzwiPrzeciwpozarowe: 'Okna i drzwi ppoż.',
    bramy: 'Bramy',
    rolety: 'Rolety',
  },
  en: {
    ...
    drzwi: 'Doors',
    oknaDrzwiPrzeciwpozarowe: 'Fire-rated windows & doors',
    bramy: 'Gates',
    rolety: 'Shutters',
  },
  de: {
    ...
    drzwi: 'Türen',
    oknaDrzwiPrzeciwpozarowe: 'Brandschutzfenster & -türen',
    bramy: 'Garagentore',
    rolety: 'Rollläden',
  },
  fr: {
    ...
    drzwi: 'Portes',
    oknaDrzwiPrzeciwpozarowe: 'Fenêtres & portes coupe-feu',
    bramy: 'Portails',
    rolety: 'Volets',
  },
};
