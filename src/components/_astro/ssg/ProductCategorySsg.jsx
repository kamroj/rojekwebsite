 ...
 */
export default function ProductCategorySsg({ lang = 'pl', resources, category, initialSanityProducts }) {
  return (
    <I18nBoundary lang={lang} resources={resources}>
      <ProductCategoryViewAstro category={category} initialSanityProducts={initialSanityProducts} />
    </I18nBoundary>
  );
}
